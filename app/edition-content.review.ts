...
const content: EditionContent = {
  ...
  reviewBanner: {
    title: "WRAP TEAM REVIEW EDITION",
    subtitle: "De-identified professional preview · no responses are saved or sent",
  },
  grownupGuide: {
    title: "Grown-up Guide",
    subtitle: "Keep the fun child-led and the child’s answers their own.",
    kicker: "WRAP TEAM REVIEW",
    heading: "What should the care team notice?",
    checklist: [
      "Does the language feel neutral, concrete, and right for an early reader?",
      "Could any activity feel leading, activating, or too close to a forensic interview?",
      "Which coping choices match the child’s existing safety and regulation plans?",
      "Should the Pause Portal or Meeting Loadout choices be renamed for this child?",
      "Can each professional approve the wording that describes their role and privacy limits?",
    ...
    cards: [
      ...
      { icon: "🎵", title: "Familiar music", body: "Praise Power-Up opens only the parent-curated playlist after a deliberate tap. It never embeds, autoplays, modifies the playlist, tracks listening activity, or records the child’s signal check." },
    ...
    noticeBody: "Brave Blocks supports play and practice. It is not therapy, a forensic interview, or legal advice.",
  },
};
